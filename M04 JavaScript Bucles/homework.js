...
function fizzBuzz(num) {
   ...
   return num % 3 === 0 && num % 5 === 0 ? 'fizzbuzz' :
          num % 3 === 0 ? 'fizz' : num % 5 === 0 ? 'buzz' : false
}
...
function operadoresLogicos(num1, num2, num3) {
   ...
   // Tu código:
   let arr = [...arguments]
   return arr.some(num => num < 0) ? 'Hay negativos' : 
          arr.every(num => num === 0) ? 'Error' :
          num1 > num2 && num1 > num3 ? 'Numero 1 es mayor y positivo' :
...
function doWhile(num) {
   ...
   do {
      incrementedNum = incrementedNum + 5
      i = i + 1
   } while (i < 9)
